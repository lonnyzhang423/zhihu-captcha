...
__all__ = ["text2vector", "vector2text", "img2array",
           ...
           "predict_checkpoints_dir", "classify_checkpoints_dir"]
...
def next_predict_batch(batch_size=64):
    """
    produce batch samples for prediction
    """
...
def predict_checkpoints_dir():
    return os.path.join(os.path.dirname(__file__), "predict/checkpoints")
